 <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper" data-layout="stroke-svg">
          <div>
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{ asset('') }}assets/images/logo_light.png" alt=""></a>
            ...
            <nav class="sidebar-main">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  <li class="back-btn"><a href="index.html"><img class="img-fluid" src="{{ asset('') }}assets/images/logo-icon.png" alt=""></a>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="/">
                      <svg class="stroke-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#stroke-home')}}"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-home')}}"></use>
                      </svg><span>Dashboard</span></a>
                  </li>
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#stroke-user')}}"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-user')}}"></use>
                      </svg><span>Students</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="{{ route('student.list') }}">Students</a></li>
                      <li><a href="{{ route('student.profile') }}">Student Profile</a></li>
                      <li><a href="jsgrid-table.html">Hostel & Room Allocation </a></li>
                      <li><a class="submenu-title" href="javascript:void(0)">Student Manage<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                        <ul class="nav-sub-childmenu submenu-content">
                          <li><a href="bootstrap-basic-table.html">Item Issue</a></li>
                          <li><a href="table-components.html">Item Deposit</a></li>
                          <li><a href="bootstrap-basic-table.html">Room Change Request</a></li>
                          <li><a href="table-components.html">Guardian Visits</a></li>
                          <li><a href="bootstrap-basic-table.html">Leave & Gate Pass</a></li>
                          <li><a href="table-components.html">Student Deactive</a></li>
                        </ul>
                      </li>
                      <li><a href="datatable-ext-autofill.html">Student Performance</a></li>
                      <li><a href="datatable-ext-autofill.html">Student Logs</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#stroke-calendar')}}"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-calendar')}}"></use>
                      </svg><span>Attendance</span></a>
                    <ul class="sidebar-submenu">
                      <li><a class="submenu-title" href="javascript:void(0)">Hostel Attendance<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                        <ul class="nav-sub-childmenu submenu-content">
                          <li><a href="bootstrap-basic-table.html">Attendance</a></li>
                          <li><a href="table-components.html">Daily Report</a></li>
                          <li><a href="bootstrap-basic-table.html">Daily Summary</a></li>
                          <li><a href="table-components.html">Monthly Report</a></li>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#stroke-knowledgebase')}}"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-knowledgebase')}}"></use>
                      </svg><span>System Setting</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="{{ route('hostel.profile') }}">Hostel Profile</a></li>
                      <li><a class="submenu-title" href="javascript:void(0)">List of Master<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                        <ul class="nav-sub-childmenu submenu-content">
                          <li><a href="{{ route('floors') }}">Floors</a></li>
                          <li><a href="{{ route('rooms') }}">Rooms</a></li>
                          <li><a href="{{ route('beds') }}">Beds</a></li>
                          <li><a href="{{ route('classes') }}">Class</a></li>
                          <li><a href="{{ route('sections') }}">Section</a></li>
                          <li><a href="{{ route('mediums') }}">Medium</a></li>
                          <li><a href="{{ route('categories') }}">Categories</a></li>
                          <li><a href="{{ route('fee.plans') }}">Fee Plans</a></li>
                          <li><a href="{{ route('sessions') }}">Sessions</a></li>
                        </ul>
                        <li><a href="datatable-ext-autofill.html">Report Setting</a></li>
                        <li><a href="datatable-ext-autofill.html">Users</a></li>
                        <li><a href="datatable-ext-autofill.html">Roles</a></li>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#stroke-layout')}}"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-layout')}}"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack">    </i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#stroke-project')}}"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-project')}}"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="file-manager.html">
                      <svg class="stroke-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#stroke-file')}}"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-file')}}"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack">        </i><a class="sidebar-link sidebar-title link-nav" href="kanban.html">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-board"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-board')}}"></use>
                      </svg><span>kanban Board</span></a>
                  </li>
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#stroke-ecommerce')}}"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-ecommerce')}}"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="letter-box.html">
                      <svg class="stroke-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#stroke-email')}}"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-email')}}"> </use>
                      </svg><span>Letter Box</span></a></li>
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#stroke-chat')}}"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-chat')}}"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="bookmark.html">
                      <svg class="stroke-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#stroke-bookmark')}}"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-bookmark')}}"> </use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="contacts.html">
                      <svg class="stroke-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#stroke-contact')}}"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-contact')}}"> </use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="task.html">
                      <svg class="stroke-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#stroke-task')}}"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-task')}}"> </use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="calendar-basic.html">
                      ...
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-calender')}}"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="social-app.html">
                      <svg class="stroke-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#stroke-social')}}"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-social"> </use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="to-do.html">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-to-do"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-to-do"> </use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="search.html">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-search"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-search"> </use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-form"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-form"> </use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-table"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-table"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-ui-kits"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-ui-kits"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-bonus-kit"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-bonus-kit"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-animation"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-animation"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-icons"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-icons"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="buttons.html">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-button"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-button"></use>
                      </svg><span>Buttons </span></a></li>
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-charts"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-charts"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="landing-page.html">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-landing-page"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-landing-page"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="sample-page.html">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-sample-page"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-sample-page"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="internationalization.html">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-internationalization"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-internationalization"></use>
                  ...
                  <li class="mega-menu sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-others"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-others"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-gallery"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-gallery"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-blog"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-blog"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="faq.html">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-faq"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-faq"></use>
                      </svg><span>FAQ</span></a></li>
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-job-search"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-job-search"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-learning"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-learning"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-editors"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-editors"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="knowledgebase.html">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-knowledgebase"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="images/icon-sprite.svg#fill-knowledgebase"></use>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="support-ticket.html">
                      <svg class="stroke-icon">
                        <use href="images/icon-sprite.svg#stroke-support-tickets"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="{{ asset('assets/images/icon-sprite.svg#fill-support-tickets')}}"></use>
